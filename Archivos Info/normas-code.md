...
Ademas cada seccion SIEMPRE debe tener la etiqueta de la seccion y dentro un div que englobe lo mismo pero sea hijo de la etiqueta seccion llamado "contenido-"seccion"", como en el siguiente ejemplo:
